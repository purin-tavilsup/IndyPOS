        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupPrice = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    GroupPriceQuantity = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoreFullName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    AddressLine1 = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    AddressLine2 = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    PhoneNumber = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    PrinterName = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    LastModifiedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ClientId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoreConfigs", x => x.StoreId);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryMovements_StoreId_ProductId",
                table: "InventoryMovements",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProcessedEvents_StoreId_EventType",
                table: "ProcessedEvents",
                columns: new[] { "StoreId", "EventType" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StoreConfigs_ClientId",
                table: "StoreConfigs",
                column: "ClientId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StoreConfigs_IsActive",
                table: "StoreConfigs",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_SyncedEvents_EventId",
                table: "SyncedEvents",
                column: "EventId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SyncedEvents_ProcessedAtUtc",
                table: "SyncedEvents",
                column: "ProcessedAtUtc");

            migrationBuilder.CreateIndex(
                name: "IX_SyncedEvents_StoreId_EventType",
                table: "SyncedEvents",
                columns: new[] { "StoreId", "EventType" });
