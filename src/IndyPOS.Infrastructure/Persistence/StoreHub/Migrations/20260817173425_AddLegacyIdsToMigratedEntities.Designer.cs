...
namespace IndyPOS.Infrastructure.Persistence.StoreHub.Migrations
{
    ...
    [Migration("20260817173425_AddLegacyIdsToMigratedEntities")]
    partial class AddLegacyIdsToMigratedEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IndyPOS.Domain.Entities.Core.InvoiceLine", b =>
                {
                    ...
                    b.Property<int?>("LegacyInvoiceLineId")
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("InvoiceId", "LegacyInvoiceLineId")
                        .IsUnique();
            ...
            modelBuilder.Entity("IndyPOS.Domain.Entities.Core.Payment", b =>
                {
                    ...
                    b.Property<int?>("LegacyPaymentId")
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("InvoiceId", "LegacyPaymentId")
                        .IsUnique();

                    b.ToTable("payment", (string)null);
                });

            modelBuilder.Entity("IndyPOS.Domain.Entities.Core.PaymentMethod", b =>
                {
                    b.Property<string>("StoreId")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
            ...
            modelBuilder.Entity("IndyPOS.Domain.Entities.Core.Product", b =>
                {
                    ...
                    b.HasIndex("StoreId", "LegacyProductId")
                        .IsUnique();
