...
| 2 | **SQLite → PostgreSQL migration hardening** | 🚧 **IN PROGRESS** — test harness landed; defects 2, 3, 4, 9, 10, 11, 12 fixed; 5/6/7/8/13 pinned | 3 divergent legacy schemas. The risky half of the rollout |
